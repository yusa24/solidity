...
{
	CHECK_PARSE_WARNING("{ jump(44) }", TypeError, "The identifier \"jump\" can not be used.");
	CHECK_PARSE_WARNING("{ jumpi(44, 2) }", TypeError, "The identifier \"jumpi\" can not be used.");
}
